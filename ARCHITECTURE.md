...
The **Customer Support Backend** is a **full-featured operational CRM** that serves as the system of record for all customer support operations. It is NOT a thin proxy or API gateway - it is a complete operational platform that manages tickets, agents, assignments, SLA tracking, and integrations.

**Key Principle**: This backend owns all operational data and workflows. It integrates with **Quimbi Backend** to enrich support decisions with AI-powered customer intelligence, but remains fully functional even when Quimbi is unavailable.
...
Quimbi Backend = "What does the AI think about this customer?"
                 (Intelligence Layer - Stateless)

Support Backend = "How do we operationally handle this ticket?"
                  (Operations Layer - Stateful System of Record)
```

**Ownership Boundaries**:
- **Quimbi Backend**: Stateless AI/ML engine providing intelligence
  - Customer DNA analysis, segmentation, predictions
  - No operational data storage
  - No knowledge of tickets, agents, assignments

- **Support Backend**: Stateful operational CRM (This System)
  - System of record for tickets, messages, agents, assignments
  - Complete ticket lifecycle management
  - SLA tracking, escalation, routing
  - Integration orchestration (Gorgias, Zendesk, Shopify)
  - Caches Quimbi intelligence to reduce dependency
